...
<!-- See CLAUDE.md for complete outline guidance. This file is a minimal skeleton/placeholder.
Use ANY slide templates in ANY order (repeat/skip as needed).
Bias toward being overly verbose and specific here: include exact numbers, quotes, labels, and chart references. The outline is closest to source ingestion, so capture maximal detail to produce better slides. -->
...
<!-- EXAMPLE ONLY - Showing detail level required: -->
